...
let ind_weak_thm =
  ...
  $ unwords
      ...
      ; "forall t :term. "
      ; "  (forall a :atom. (P {a})) =>"
      ; "  (forall t1 t2 :term. (P t1) => (P t2) => (P {t1 t2})) =>"
      ; "  (forall a :atom. forall e :term. (P e) => (P {a.e})) =>"
      ; "  (forall s :term. [symbol s] => (P s)) =>"
      ; "    P t" ]
...
let ind_strong'_thm =
  ...
  $ unwords
      ...
      ; "  (forall a :atom. (P {a})) =>"
      ; "  (forall t1 t2 :term. (P t1) => (P t2) => (P {t1 t2})) =>"
      ; "  (forall c :term. forall a :atom. forall e :term. [a # c] => (P e) => (P {a.e})) =>"
      ; "  (forall s :term. [symbol s] => (P s)) =>"
      ; "    P t" ]
...
let ind_strong_thm =
  theorem
  $ unwords
      [ "forall P : (forall c :term. forall t :term. prop)."
      ; "forall context t :term."
      ; "  (forall c :term. forall a :atom. (P c {a})) =>"
      ; "  (forall c :term. forall t1 t2 :term. "
      ; "     (forall c' :term. P c' t1) =>"
      ; "     (forall c' :term. P c' t2) =>"
      ; "                    (P c {t1 t2})) =>"
      ; "  (forall c :term. forall a :atom. forall e :term."
      ; "     [a # c] =>"
      ; "     (forall c' :term. P c' e) =>"
      ; "                    (P c {a.e})) =>"
      ; "  (forall c :term. forall s :term. [symbol s] => (P c s)) =>"
      ; "    P context t" ]
...
let ind_weak =
  proof' ind_weak_thm
  |> repeat intro %> intros ["Hatom"; "Happ"; "Hlam"; "Hsym"]
  |> apply_thm_spec ind_strong' ["P"; "t"; "t"]
  |> apply_assm "Hatom"
  |> apply_assm "Happ"
  |> repeat intro %> apply_assm_spec "Hlam" ["a"; "e"]
  |> apply_assm "Hsym"
  |> qed
