...
let preservation =
  ...
  |> intros' ["He1"; "e1"; "e1'"; "e2"; ""; ""] (* e = app e1 e2, Steps e1 e1' *)
     ...
     %> by_solver %> apply_assm "Happ_1" %> apply_assm "He1"
     (* Typing e2 env t2 *)
     %> apply_assm "Happ_2"
  |> intros' ["He2"; "v1"; "e2"; "e2'"; ""; ""; ""] (* e = app v1 e2, Value e1, Steps e2 e2' *)
     ...
     %> by_solver %> apply_assm "Happ_2" %> apply_assm "He2_2"
  |> intros' ["Hbeta"; "a"; "e_a"; "v"; ""; ""] (* e = app (lam (a.e_a)) v, Value v *)
     %> deduce_app_typing %> destruct_assm "Happ_1" %> contra_var (* e_1 =/= var *)
     ...
     %> destr_intro (* a = b *) %> apply_assm "Hlam_2"
     %> destr_intro (* a =/= b *)
