...
type incproof =
  ...
  | PI_ExistsProp of judgement * formula * incproof
...
type proof_context =
  ...
  | PC_ExistsProp of judgement * formula * proof_context
...
let rec normalize incproof =
  ...
  | PI_ExistsProp (jgmt, witness, witness_proof) -> proof_exists_form jgmt witness witness_proof
...
and proof_intro jgmt conclusion_proof =
  ...
  | PI_Proven proof -> (
    ...
    | _, F_ForallProp (x, _) -> proven $ forall_form_i x proof
...
and proof_exists_form jgmt witness witness_proof =
  match (snd jgmt, normalize witness_proof) with
  | F_ExistsProp (x, f), PI_Proven witness_proof -> proven $ exists_form_i x witness f witness_proof
  | _, incproof -> PI_ExistsProp (jgmt, witness, incproof)
...
let rec find_hole_in_proof context = function
  ...
  | PI_ExistsProp (jgmt, witness, incproof) -> find_hole_in_proof (PC_ExistsProp (jgmt, witness, context)) incproof
...
let rec meld incproof = function
  ...
  | PC_ExistsProp (jgmt, witness, ctx) -> meld (proof_exists_form jgmt witness incproof) ctx
