...
fresh in the whole right side's term (either arguments are the same or left's argument doesnt occur in right's body)
...
There's three possible ways: \begin{enumerate}
