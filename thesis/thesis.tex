...
\section{Subkinding}
\[
\dfrac{}{\cEnv \vdash \kind \subkind \kind}
\qquad
\dfrac{\cEnv \vdash \kind_1 \subkind \kind_2
  \quad \cEnv \vdash \kind_2 \subkind \kind_3}{
  \cEnv \vdash \kind_1 \subkind \kind_3}
\qquad
\dfrac{\cEnv \vdash \kind_1 \subkind \kind_2}{
  \cEnv \vdash \kForallAtom{\atomv} \kind_1
       \subkind \kForallAtom{\atomv} \kind_2}
\qquad
\dfrac{\cEnv \vdash \kind_1 \subkind \kind_2}{
  \cEnv \vdash \kForallTerm{\termv} \kind_1
       \subkind \kForallTerm{\termv} \kind_2}
\]
\[
\dfrac{\cEnv \vdash \kind_1' \subkind \kind_1
  \quad \cEnv \vdash \kind_2 \subkind \kind_2'}{
  \cEnv \vdash \kind_1 \karrow \kind_2 \subkind \kind_1' \karrow \kind_2'}
\qquad
\dfrac{\cEnv \vDash \constr}{
  \cEnv \vdash \kGuard{\constr}\kind \subkind \kind}
\qquad
\dfrac{\cEnv, \constr \vdash \kind_1 \subkind \kind_2}{
...
\[
\dfrac{}{\cEnv; \kEnv \vdash \fConstr{\constr} \ofkind \kProp}
\qquad
\dfrac{\cEnv,\constr; \kEnv \vdash \formphi \ofkind \kProp }{
  \cEnv; \kEnv \vdash \fCAnd{\constr} \formphi \ofkind \kProp}
\qquad
\dfrac{\cEnv,\constr; \kEnv \vdash \formphi \ofkind \kProp }{
  \cEnv; \kEnv \vdash \fCImp{\constr} \formphi \ofkind \kProp}
\qquad
\dfrac{\cEnv;\kEnv\vdash \formphi \ofkind \kind_1
  \quad
  \cEnv\vdash \kind_1 \subkind \kind_2}{
  \cEnv;\kEnv\vdash \formphi \ofkind \kind_2}
\]
...
\begin{eqnarray*}
  ...
  \inference{
    ...
    \jgmnt[\cEnv;\Theta]{\phi}
  }[(\ensuremath{constr^e})]
\end{eqnarray*}
\begin{eqnarray*}
  \inference{
    \jgmnt[\cEnv;\Theta,\phi_1]{\phi_2}
  }{
    \jgmnt[\cEnv;\Theta]{\phi_1 \fImp \phi_2}
  }[(\ensuremath{\fImp^i})]
  \qquad
  \inference{
    \jgmnt[\cEnv_1;\Theta_1]{\phi_1} &
    \jgmnt[\cEnv_2;\Theta_2]{\phi_1 \fImp \phi_2}
    }{
    \jgmnt[\cEnv_1 \cup \cEnv_2;\Theta_2 \cup \Theta_2]{\phi_2}
  }[(\ensuremath{\fImp^e})]
\end{eqnarray*}
\begin{eqnarray*}
  \inference{
    \jgmnt[\cEnv, \constr;\Theta]{\phi}
  }{
    \jgmnt[\cEnv;\Theta]{\fCImp{\constr}\phi}
  }[(\ensuremath{\fCImp{\cdot}^i})]
  \qquad
  \inference{
    \jgmnt[\cEnv_1;\Theta_1]{\constr} &
    \jgmnt[\cEnv_2;\Theta_2]{\fCImp{\constr}\phi}
    }{
    \jgmnt[\cEnv_1 \cup \cEnv_2;\Theta_2 \cup \Theta_2]{\phi}
  }[(\ensuremath{\fCImp{\cdot}^e})]
\end{eqnarray*}
\begin{eqnarray*}
  \inference{
    \jgmnt[\cEnv;\Theta]{\phi_1}
    }{
    \jgmnt[\cEnv;\Theta]{\phi_1 \vee \phi_2}
  }[(\ensuremath{\vee^i_1})]
  \qquad
  \inference{
    \jgmnt[\cEnv;\Theta]{\phi_2}
  }{
    \jgmnt[\cEnv;\Theta]{\phi_1 \vee \phi_2}
  }[(\ensuremath{\vee^i_2})]
  \qquad
  \inference{
    \jgmnt[\cEnv;\Theta]{\phi_1 \vee \phi_2} \\
    \jgmnt[\cEnv;\Theta,\phi_1]{\psi} &
    \jgmnt[\cEnv;\Theta,\phi_2]{\psi}
  }{
...
\begin{eqnarray*}
  \inference{
    \jgmnt[\cEnv_1;\Theta_1]{\phi_1} &
    \jgmnt[\cEnv_2;\Theta_2]{\phi_2}
  }{
    \jgmnt[\cEnv_1 \cup \cEnv_2;\Theta_2 \cup \Theta_2]{\phi_1 \wedge \phi_2}
  }[(\ensuremath{\wedge^i})]
  \qquad
  \inference{
    \jgmnt[\cEnv;\Theta]{\phi_1 \wedge \phi_2}
    }{
    \jgmnt[\cEnv;\Theta]{\phi_1}
...
\begin{eqnarray*}
  \inference{
    ...
    \jgmnt[\cEnv;\Theta]{\fCAnd{\constr}\phi}
  ...
  \inference{
    \jgmnt[\cEnv]{\fCAnd{\constr}\phi} &
    \jgmnt[\cEnv;\Theta]{\phi: \kProp}
    }{
    \jgmnt[\cEnv;\Theta]{\phi}
...
\begin{eqnarray*}
  \inference{
    ...
    \jgmnt[\cEnv;\Theta]{\fForallAtom{\atomv}\phi}
  }[(\ensuremath{{\fForallAtom{}}^i})]
  \qquad
  \inference{
    \jgmnt[\cEnv;\Theta]{\fForallAtom{\atomv}\phi}
  }{
    \jgmnt[\cEnv;\Theta]{\phi \{\atomv \mapsto \atomv'\}}
...
\begin{eqnarray*}
  \inference{
    ...
    \jgmnt[\cEnv;\Theta]{\fForallTerm{\termv}\phi}
  }[(\ensuremath{{\fForallTerm{}}^i})]
  \qquad
  \inference{
    \jgmnt[\cEnv;\Theta]{\fForallTerm{\termv}\phi}
  }{
    \jgmnt[\cEnv;\Theta]{\phi \{\termv \mapsto \termv'\}}
...
\begin{eqnarray*}
  \inference{
    ...
    \jgmnt[\cEnv;\Theta]{\fExistsAtom{\atomv}\phi}
  }[(\ensuremath{{\fExistsAtom{}}^i})]
  \qquad
  \inference{
    \jgmnt[\cEnv_1;\Theta_1]{\fExistsAtom{\atomv}\phi} \\
    \jgmnt[\cEnv_2;\Theta_2,\phi \{\atomv \mapsto \atomv'\}]{\psi} \\
...
\begin{eqnarray*}
  \inference{
    ...
    \jgmnt[\cEnv;\Theta]{\fExistsTerm{\termv}\phi}
  }[(\ensuremath{{\fExistsTerm{}}^i})]
  \qquad
  \inference{
    \jgmnt[\cEnv_1;\Theta_1]{\fExistsTerm{\termv}\phi} \\
    \jgmnt[\cEnv_2;\Theta_2,\phi \{\termv \mapsto \termv'\}]{\psi} \\
    \termv' \notin \fv[\cEnv_1 \cup \cEnv_2;\Theta_2 \cup \Theta_2]
    }{
    \jgmnt[\cEnv_1 \cup \cEnv_2;\Theta_2 \cup \Theta_2]{\psi}
...
\begin{eqnarray*}
  \inference{
    ...
    \jgmnt[\cEnv\{\atomv \mapsto \atomexp\};\Theta\{\atomv \mapsto \atomexp\}]{\phi\{\atomv \mapsto \atomexp\}}
  }[(\ensuremath{\mapsto_A})]
\qquad
  \inference{
    ...
    \jgmnt[\cEnv\{\termv \mapsto \term\};\Theta\{\termv \mapsto \term\}]{\phi\{\termv \mapsto \term\}}
  }[(\ensuremath{\mapsto_T})]
\end{eqnarray*}
\begin{eqnarray*}
  \inference{
    \jgmnt[\cEnv;\Theta]{\psi} &
    \jgmnt[\cEnv;\Theta]{\psi \equiv \phi}
    }{
    \jgmnt[\cEnv;\Theta]{\phi}
  }[(\ensuremath{Equiv})]
\end{eqnarray*}
\begin{eqnarray*}
  \inference{
    \jgmnt[\cEnv;\Theta, (\fForallTerm{\termv'} \fCImp{\termv' \cshlt \termv} \phi(\termv'))]{\phi(\termv)}
    }{
    \jgmnt[\cEnv;\Theta]{\fForallTerm{\termv} \phi(\termv)}
...
\begin{eqnarray*}
  \inference{
    ...
    \jgmnt[]{\fForallTerm{\termv} (\fExistsAtom{\atomv}\: \termv = \atomv)
                             \vee (\fExistsAtom{\atomv}\:\fExistsTerm{\termv'}\: \termv = \tbind{\atomv}{\termv'})
                             \vee (\fExistsTerm{\termv_1,\:\termv_2}\: \termv = \tbind{\atomv}{\termv'})
                             \vee ({symbol}\: \termv)
    }
...
\begin{eqnarray*}
    \interp{
        \inference{D_1 : \types{\phi_1 }{\kProp} \\ D_2 : \types{\phi_2 }{\kProp}
    }{
        \types{\phi_1 \wedge \phi_2}{\kProp}}
    } & = & \interp{D_1} \wedge_\PropAlg \interp{D_2} \\
    \interp{
        \inference{D_1 : \types{\phi_1 }{\kProp}  \\ D_2 : \types{\phi_2 }{\kProp}
    }{
        \types{\phi_1 \vee \phi_2}{\kProp}}
    } & = & \interp{D_1} \vee_\PropAlg \interp{D_2} \\
    \interp{
        \inference{D_1 : \types{\phi_1 }{\kProp}  \\ D_2 : \types{\phi_2 }{\kProp}
    }{
        \types{\phi_1 \Rightarrow \phi_2}{\kProp}}
    } & = & \interp{D_1} \Rightarrow_\PropAlg \interp{D_2}
\end{eqnarray*}

\begin{eqnarray*}
    \interp{
        \inference{D : \types{\phi}{\kProp}
    }{
        \types{\fForallTerm{\termv}\phi}{\kProp}}
    } & = & \underset{T \in Term}{\bigwedge} {\interp[{\tmEnv [\termv \mapsto T]}]{D}}  \\
    \interp{
        \inference{D : \types{\phi}{\kProp}
    }{
        \types{\fForallAtom{\atomv}\phi}{\kProp}}
    } & = & \underset{A \in Atom}{\bigwedge} {\interp[{\tmEnv [\atomv \mapsto A]}]{D}} \\
    \interp{
        \inference{D : \types{\phi}{\kProp}
    }{
        \types{\fExistsTerm{\termv} \phi}{\kProp}}
    } & = & \underset{T \in Term}{\bigvee}\interp[{\tmEnv [\termv \mapsto T]}]{D} \\
    \interp{
        \inference{D : \types{\phi}{\kProp}
    }{
        \types{\fExistsAtom{\atomv} \phi}{\kProp}}
    } & = & \underset{A \in Atom}{\bigvee} \interp[{\tmEnv [\atomv \mapsto A]}]{D}
\end{eqnarray*}

\begin{eqnarray*}
   \interp{
        \inference{D : \types[\Gamma, c]{\phi}{\kProp}
    }{
        \types{[c] \wedge \phi}{\kProp}}
    } & = &  \texttt{if } \tmEnv \vDash c \texttt{ then } \interp{D} \texttt{ else } \bot
    \\
    \interp{
        \inference{D : \types[\Gamma, c]{\phi}{\kProp}
    }{
        \types{[c] \Rightarrow \phi}{\kProp}}
    } & = &  \texttt{if } \tmEnv \vDash c \texttt{ then } \interp{D} \texttt{ else } \top
\end{eqnarray*}

\begin{eqnarray*}
    \interp{\inference{D : \types{\phi}{\kind_2}}{\types{\lam[\propv]\phi}{\kind_1\karr\kind_2}}} & = &
    \lambda\;(Q : \interp{\kind_1}).\;\interp[{\tmEnv[\propv\mapsto Q]}]{D}
    \\
    \interp{\inference{D: \types{\phi}{\kind}}{\types{\lam[\atomv]\phi}{\kForallAtom{\atomv}\kind}}} & = &
    \lambda\;(A : Atom).\;\interp[{\tmEnv[\atomv\mapsto A]}]{D}
    \\
    \interp{\inference{D: \types{\phi}{\kind}}{\types{\lam[\termv]\phi}{\kForallTerm{\termv}\kind}}} & = &
    \lambda\;(T : Term).\;\interp[{\tmEnv[\termv\mapsto T]}]{D}
\end{eqnarray*}

\begin{eqnarray*}
    \interp{\inference{D_1: \types{\phi_1}{\kind'\karr\kind} \\ D_2: \types{\phi_2}{\kind'}}{\types{\phi_1\;\phi_2}{\kind}}} & = &
    \interp{D_1}\; \interp{D_2}
    \\
    \interp{\inference{D: \types{\phi}{\kForallAtom{\atomv}\kind}}{\types{\phi(\atomexp)}{\kind\{\atomv \mapsto \atomexp\}}}} & = &
    \interp{D}\;\interp{\atomexp}
    \\
    \interp{\inference{D: \types{\phi}{\kForallTerm{\termv}\kind}}{\types{\phi(\term)}{\kind\{\termv \mapsto \term\}}}} & = &
...
\begin{eqnarray*}
    \interp{\inference{
            D : \types[{\Gamma, X : {\all[z]{[z < \termv']}}\;\kind\subst{z}{\termv'}}]\phi\kind
        }{
            \types{\fix{X}{\termv'}\phi}{\all[\termv']\kind}
        }} & = & \lim_{n \rightarrow \infty} f_n
    \\
    & & \texttt{ where } f_0(t) = \bot \\
    & & \texttt{ and } f_{n+1}(t) = \interp[{\tmEnv[X\mapsto f_n, \termv' \mapsto t]}]{D} \\
    \interp{\inference{
            D : \types[\Gamma, c]\phi\kind
        }{
            \types{\phi}{[c]\kind}
...
For any formula $\phi$, any kind $\kind$, and any environment $\Gamma$, for any kind derivation $D : \types\phi\kind$ under any interpretation $\tmEnv \in \interp[]{\Gamma}$, we have that
$$
