...
The equivalence relation ($\formphi_1 \equiv \formphi_2$) is rather straightforward,
the only interesting parts being fixpoint, functions and applications.
\begin{eqnarray*}
  \inference{
...
\end{eqnarray*}
(TODO: Also we do kind-checking).
Otherwise we compute weak head normal form and recurse on subformulas:
\begin{eqnarray*}
  \inference{
...
\end{eqnarray*}
Until we \textit{run out of gas} or cannot compute the formula further,
resorting to \textit{naive} checking:
\begin{eqnarray*}
  \inference{
...
(TODO: Also we do constraints-equivalence).
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Model}
